...
namespace CalamityModClassicPreTrailer.NPCs.Scavenger
{
	...
	public class ScavengerBody : ModNPC
	{
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			...
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<Bloodstone>(), 1, 50, 61));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<VerstaltiteBar>(), 1, 5, 11));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<DraedonBar>(), 1, 5, 11));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<CruptixBar>(), 1, 5, 11));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<CoreofCinder>(), 1, 1, 4));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<CoreofEleum>(), 1, 1, 4));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<CoreofChaos>(), 1, 1, 4));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<BarofLife>(), 2));
			notExpert.OnSuccess(ItemDropRule.ByCondition(new DownedProvidence(), ModContent.ItemType<CoreofCalamity>(), 3));
