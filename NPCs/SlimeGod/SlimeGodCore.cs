...
namespace CalamityModClassicPreTrailer.NPCs.SlimeGod
{
	...
	public class SlimeGodCore : ModNPC
	{
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			...
			corePresent.OnSuccess(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(),
				ModContent.ItemType<SlimeGodBag>(),
				1,
				5, 5));
			corePresent.OnSuccess(ItemDropRule.BossBag(ModContent.ItemType<SlimeGodBag>()));
