...
namespace CalamityModClassicPreTrailer.NPCs
{
	public class CalamityGlobalNPCLoot : GlobalNPC
	{
		...
		{	
			...
			{
				LeadingConditionRule noDownedMechs = new LeadingConditionRule(new NoDownedMechBosses());
				noDownedMechs.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge20").Type, 1));
				npcLoot.Add(noDownedMechs);
			}
			...
			{
				LeadingConditionRule noDownedEoC = new LeadingConditionRule(new NotDownedEye());
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedEye(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2, 2));
				noDownedEoC.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge3").Type, 1));
				npcLoot.Add(noDownedEoC);
			}
			else if (npc.type == NPCID.QueenBee)
			{
				LeadingConditionRule noDownedQB = new LeadingConditionRule(new NotDownedQB());
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedQB(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2));
				noDownedQB.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge16").Type, 1));
				npcLoot.Add(noDownedQB);
			}
			else if (npc.type == NPCID.TheDestroyer)
			{
				LeadingConditionRule noDownedDestroyer = new LeadingConditionRule(new NotDownedDestroyer());
				...
				noDownedDestroyer.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge21").Type, 1));
				npcLoot.Add(noDownedDestroyer);
			}
			else if (npc.type == NPCID.Spazmatism)
			{
				LeadingConditionRule noDownedTwins = new LeadingConditionRule(new NotDownedTwins());
				...
				noDownedTwins.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge22").Type, 1));
				npcLoot.Add(noDownedTwins);
			}
			else if (npc.type == NPCID.SkeletronPrime)
			{
				LeadingConditionRule noDownedPrime = new LeadingConditionRule(new NotDownedPrime());
				...
				noDownedPrime.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge23").Type, 1));
				npcLoot.Add(noDownedPrime);
			}
			else if (npc.type == NPCID.Plantera)
			{
				LeadingConditionRule noDownedPlantera = new LeadingConditionRule(new NotDownedPlantera());
				...
				noDownedPlantera.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge25").Type, 1));
				npcLoot.Add(noDownedPlantera);
			}
			else if (!NPC.downedFishron && npc.type == NPCID.DukeFishron)
			{
				LeadingConditionRule noDownedDuke = new LeadingConditionRule(new NotDownedDuke());
				...
				noDownedDuke.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge2").Type, 1));
				npcLoot.Add(noDownedDuke);
			}
			else if (npc.type == NPCID.CultistBoss)
			{
				LeadingConditionRule noDownedCultist = new LeadingConditionRule(new NotDownedCultist());
				LeadingConditionRule bMandNotStatue = new LeadingConditionRule(new Conditions.IsBloodMoonAndNotFromStatue());
				...
				noDownedCultist.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge4").Type, 1)); 
				noDownedCultist.OnSuccess(bMandNotStatue).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge34").Type, 1));
				npcLoot.Add(noDownedCultist);
			}
			#region DefiledLoot
			...
			#region ArmageddonLoot
				...
				if (npc.type == NPCID.Golem)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.GolemBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.DukeFishron)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.FishronBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.DD2Betsy)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.BossBagBetsy, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.EyeofCthulhu)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.EyeOfCthulhuBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.BrainofCthulhu)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.BrainOfCthulhuBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.EaterofWorldsHead || npc.type == NPCID.EaterofWorldsBody || npc.type == NPCID.EaterofWorldsTail)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.EaterOfWorldsBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.QueenBee)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.QueenBeeBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.SkeletronHead)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.SkeletronBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.WallofFlesh)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.WallOfFleshBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.MoonLordCore)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.MoonLordBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.KingSlime)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.KingSlimeBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.Retinazer || npc.type == NPCID.Spazmatism)
				{
					LeadingConditionRule oneTwin = new LeadingConditionRule(new OneTwinPresent(npc));
					oneTwin.OnSuccess(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.TwinsBossBag, 1, dropAmt, dropAmt));
					npcLoot.Add(oneTwin);
				}
				else if (npc.type == NPCID.SkeletronPrime)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.SkeletronPrimeBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.TheDestroyer)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.DestroyerBossBag, 1, dropAmt, dropAmt));
				}
				else if (npc.type == NPCID.Plantera)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new ArmageddonDropRuleCondition(), ItemID.PlanteraBossBag, 1, dropAmt, dropAmt));
				}
			#endregion
			...
			if (npc.type == Mod.Find<ModNPC>("DesertScourgeHead").Type)
			{
				...
				LeadingConditionRule noDownedDS = new LeadingConditionRule(new NotDownedDS());
				...
				notExpert.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("AeroStone").Type, 10));
				npcLoot.Add(notExpert);
				SkeletronDead.OnSuccess(ItemDropRule.ByCondition(new Conditions.NotExpert(),ItemID.GoldenBugNet, 20));
				npcLoot.Add(SkeletronDead);
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedDS(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2));
				noDownedDS.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge").Type, 1));
				npcLoot.Add(noDownedDS);
			}
			else if (npc.type == Mod.Find<ModNPC>("AquaticScourgeHead").Type)
			{
				LeadingConditionRule notDownedAS = new LeadingConditionRule(new NotDownedAquaticScourge());
				...
				notExpert.OnSuccess(isHardmode).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("AeroStone").Type, 5));
				...
				preHardmode.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("AeroStone").Type, 10));
				npcLoot.Add(preHardmode);
				...
				notDownedAS.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge27").Type, 1));
				notDownedAS.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge35").Type, 1));
				npcLoot.Add(notDownedAS);
			}
			else if (npc.type == Mod.Find<ModNPC>("AstrumDeusHeadSpectral").Type)
			{
				LeadingConditionRule notDownedAstrumDeus = new LeadingConditionRule(new NotDownedAstrumDeus());
				...
				notDownedAstrumDeus.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge29").Type, 1));
				notDownedAstrumDeus.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge36").Type, 1));
				npcLoot.Add(notDownedAstrumDeus);
				npcLoot.Add(new CommonDrop(ItemID.GreaterHealingPotion, 1, 8, 15));
				...
				notExpert.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("AstrumDeusMask").Type, 7));
				npcLoot.Add(notExpert);
			}
			else if (npc.type == Mod.Find<ModNPC>("DevourerofGodsHeadS").Type)
			{
				LeadingConditionRule notDownedDoG = new LeadingConditionRule(new NotDownedDoG());
				notDownedDoG.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge42").Type, 1));
				npcLoot.Add(notDownedDoG);
			...
			if (npc.type == NPCID.PossessedArmor)
			{
				...
				npcLoot.Add(ItemDropRule.ByCondition(new DefiledCondition(), Mod.Find<ModItem>("PsychoticAmulet").Type, 20));
			}
			...
			if (npc.type == NPCID.EaterofWorldsHead || npc.type == NPCID.EaterofWorldsBody || npc.type == NPCID.EaterofWorldsTail || npc.type == NPCID.BrainofCthulhu)
			{
				...
				LeadingConditionRule notDownedEvilBoss = new LeadingConditionRule(new NotDownedEvilBoss());
				if (npc.boss)
				{
					npcLoot.Add(ItemDropRule.ByCondition(new NotDownedEvilBoss(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2));
					
					worldIsCrimson.OnSuccess(notDownedEvilBoss).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge8").Type));
					worldIsCrimson.OnSuccess(notDownedEvilBoss).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge11").Type));
						
					worldIsCrimson.OnFailedConditions(notDownedEvilBoss).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge9").Type));
					worldIsCrimson.OnFailedConditions(notDownedEvilBoss).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge12").Type));
					npcLoot.Add(worldIsCrimson);
				}
			}
			else if (npc.type == NPCID.SkeletronHead)
			{
				LeadingConditionRule notDownedSkeletron = new LeadingConditionRule(new NotDownedSkeletron());
				...
				notDownedSkeletron.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge17").Type, 1));
				npcLoot.Add(notDownedSkeletron);
			}
			else if (npc.type == NPCID.WallofFlesh)
			{
				LeadingConditionRule preHardmode = new LeadingConditionRule(new Conditions.IsPreHardmode());
					...
					preHardmode.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge7").Type, 1));
					preHardmode.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge18").Type, 1));
					npcLoot.Add(preHardmode);
			}
			else if (npc.type == NPCID.SkeletronPrime || npc.type == Mod.Find<ModNPC>("BrimstoneElemental").Type)
			{
				if (npc.type == Mod.Find<ModNPC>("BrimstoneElemental").Type)
				{
					LeadingConditionRule notDownedBrimstoneElemental = new LeadingConditionRule(new NotDownedBrimstoneElemental());
					...
					notDownedBrimstoneElemental.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge6").Type, 1));
					notDownedBrimstoneElemental.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge26").Type, 1));
					npcLoot.Add(notDownedBrimstoneElemental);
				}
			}
			else if (npc.type == NPCID.Plantera || npc.type == Mod.Find<ModNPC>("CalamitasRun3").Type)
			{
				...
				if (npc.type == Mod.Find<ModNPC>("CalamitasRun3").Type)
				{
					npcLoot.Add(new PerPlayerDropRule(ItemID.BrokenHeroSword));
					LeadingConditionRule notDownedCalDoppel = new LeadingConditionRule(new NotDownedCalDoppel());
					...
					notDownedCalDoppel.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge24").Type, 1));
					npcLoot.Add(notDownedCalDoppel);
				}
			}
			else if (npc.type == NPCID.Golem)
			{
				LeadingConditionRule notDownedGolem = new LeadingConditionRule(new NotDownedGolem());
				...
				notDownedGolem.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge31").Type, 1));
				npcLoot.Add(notDownedGolem);
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedGolem(),ItemID.Picksaw, 1));
			}
			else if (npc.type == NPCID.MoonLordCore)
			{
				LeadingConditionRule notDownedMoonLord = new LeadingConditionRule(new NotDownedMoonLord());
				notExpert.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("MLGRune2").Type, 1));
				npcLoot.Add(notExpert);
				...
				notDownedMoonLord.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge37").Type, 1));
				npcLoot.Add(notDownedMoonLord);
			}
			else if (npc.type == NPCID.DD2Betsy)
			{
			...
			{
				LeadingConditionRule notDownedAureus = new LeadingConditionRule(new NotDownedAureus());
				...
				notDownedAureus.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge30").Type, 1));
				npcLoot.Add(notDownedAureus);
			}
			else if (npc.type == Mod.Find<ModNPC>("HiveMindP2").Type) //boss 2
			{
				LeadingConditionRule notDownedHiveMind = new LeadingConditionRule(new NotDownedHiveMind());
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedHiveMind(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2));
				notDownedHiveMind.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge14").Type, 1));
				npcLoot.Add(notDownedHiveMind);
			}
			else if (npc.type == Mod.Find<ModNPC>("PerforatorHive").Type) //boss 3
			{
				LeadingConditionRule notDownedPerforators = new LeadingConditionRule(new NotDownedPerforators());
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedPerforators(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2));
				notDownedPerforators.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge13").Type, 1));
				npcLoot.Add(notDownedPerforators);
			}
			else if (npc.type == Mod.Find<ModNPC>("SlimeGodCore").Type || npc.type == Mod.Find<ModNPC>("SlimeGodSplit").Type || npc.type == Mod.Find<ModNPC>("SlimeGodRunSplit").Type) //boss 4
			{
				if (npc.type == Mod.Find<ModNPC>("SlimeGodCore").Type)
				{
					...
					LeadingConditionRule notDownedSlimeGod = new LeadingConditionRule(new NotDownedSlimeGod());
					corePresent.OnSuccess(revActive).OnSuccess(purifiedJam).OnSuccess(notDownedSlimeGod).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("PurifiedJam").Type, 1, 6, 9)); 
					...
					corePresent.OnSuccess(notDownedSlimeGod).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge15").Type, 1));
				...
				else if (npc.type == Mod.Find<ModNPC>("SlimeGodSplit").Type)
				{
					...
					LeadingConditionRule notDownedSlimeGod = new LeadingConditionRule(new NotDownedSlimeGod());
					ebonianPresent.OnSuccess(revActive).OnSuccess(purifiedJam).OnSuccess(notDownedSlimeGod).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("PurifiedJam").Type, 1, 6, 9)); 
					...
					ebonianPresent.OnSuccess(notDownedSlimeGod).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge15").Type, 1));
				...
				else if (npc.type == Mod.Find<ModNPC>("SlimeGodRunSplit").Type)
				{
					...
					LeadingConditionRule notDownedSlimeGod = new LeadingConditionRule(new NotDownedSlimeGod());
					crimulanPresent.OnSuccess(revActive).OnSuccess(purifiedJam).OnSuccess(notDownedSlimeGod).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("PurifiedJam").Type, 1, 6, 9)); 
					...
					crimulanPresent.OnSuccess(notDownedSlimeGod).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge15").Type, 1));
			...
			{
				LeadingConditionRule notDownedCryogen = new LeadingConditionRule(new NotDownedCryogen());
				...
				notDownedCryogen.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge19").Type, 1));
				npcLoot.Add(notDownedCryogen);
			}
			else if (npc.type == Mod.Find<ModNPC>("Siren").Type || npc.type == Mod.Find<ModNPC>("Leviathan").Type) //boss 8
			{
				LeadingConditionRule leviOrSiren = new LeadingConditionRule(new LeviOrSiren(npc));
				LeadingConditionRule notDownedLeviathan = new LeadingConditionRule(new NotDownedLeviathan());
				leviOrSiren.OnSuccess(ItemDropRule.ByCondition(new NotDownedLeviathan(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 4, 4));
				leviOrSiren.OnSuccess(ItemDropRule.ByCondition(new NotDownedLeviathan(), Mod.Find<ModItem>("GrenadeRounds").Type, 1, 2, 2));
				leviOrSiren.OnSuccess(ItemDropRule.ByCondition(new NotDownedLeviathan(), Mod.Find<ModItem>("ExplosiveShells").Type, 1));
				leviOrSiren.OnSuccess(notDownedLeviathan).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge10").Type, 1));
				leviOrSiren.OnSuccess(notDownedLeviathan).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge28").Type, 1));
				npcLoot.Add(leviOrSiren);
			}
			else if (npc.type == Mod.Find<ModNPC>("PlaguebringerGoliath").Type) //boss 9
			{
				LeadingConditionRule notDownedPBG = new LeadingConditionRule(new NotDownedPBG());
				...
				notDownedPBG.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge32").Type, 1));
				npcLoot.Add(notDownedPBG);
			}
			else if (npc.type == Mod.Find<ModNPC>("ProfanedGuardianBoss").Type) //boss 10
			{
				LeadingConditionRule notDownedGuardians = new LeadingConditionRule(new NotDownedGuardians());
				...
				notDownedGuardians.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge38").Type, 1));
				npcLoot.Add(notDownedGuardians);
			}
			else if (npc.type == Mod.Find<ModNPC>("Providence").Type) //boss 11
			{
				LeadingConditionRule notDownedProvidence = new LeadingConditionRule(new NotDownedProvidence());
				...
				notDownedProvidence.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge39").Type, 1));
			}
			else if (npc.type == Mod.Find<ModNPC>("CeaselessVoid").Type) //boss 12
			{
				...
				downedCeaseless.OnSuccess(downedSignus).OnSuccess(downedSW).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge40").Type, 1));
				npcLoot.Add(downedCeaseless);
			...
			else if (npc.type == Mod.Find<ModNPC>("StormWeaverHeadNaked").Type) //boss 13
			{
				...
				downedSW.OnSuccess(downedSignus).OnSuccess(downedCeaseless).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge40").Type, 1));
				npcLoot.Add(downedSW);
			...
			else if (npc.type == Mod.Find<ModNPC>("CosmicWraith").Type) //boss 14
			{
				...
				downedSignus.OnSuccess(downedSW).OnSuccess(downedCeaseless).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge40").Type, 1));
				npcLoot.Add(downedSignus);
			...
			{
				LeadingConditionRule notDownedBumblebirb = new LeadingConditionRule(new NotDownedBumblebirb());
				notDownedBumblebirb.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge43").Type, 1));
				npcLoot.Add(notDownedBumblebirb);
			...
			else if (npc.type == Mod.Find<ModNPC>("Yharon").Type) //boss 17
			{
				...
				LeadingConditionRule notDownedYharon = new LeadingConditionRule(new NotDownedYharon());
				
				darkSun.OnSuccess(notDownedYharon).OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge44").Type, 1));
			...
			{
				LeadingConditionRule notDownedSCal = new LeadingConditionRule(new NotDownedSCal());
				notDownedSCal.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge45").Type, 1));
				npcLoot.Add(notDownedSCal);
			...
			{
				LeadingConditionRule notDownedCrabulon = new LeadingConditionRule(new NotDownedCrabulon());
				npcLoot.Add(ItemDropRule.ByCondition(new NotDownedCrabulon(), Mod.Find<ModItem>("MagnumRounds").Type, 1, 2, 2));
				notDownedCrabulon.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge5").Type, 1));
				npcLoot.Add(notDownedCrabulon);
			}
			else if (npc.type == Mod.Find<ModNPC>("ScavengerBody").Type) //boss 20
			{
				LeadingConditionRule notDownedRavager = new LeadingConditionRule(new NotDownedRavager());
				...
				notDownedRavager.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge33").Type, 1));
				npcLoot.Add(notDownedRavager);
			}
			else if (npc.type == Mod.Find<ModNPC>("Polterghast").Type) //boss 21
			{
				LeadingConditionRule notDownedPolterghast = new LeadingConditionRule(new NotDownedPolterghast());
				notDownedPolterghast.OnSuccess(new PerPlayerDropRule(Mod.Find<ModItem>("Knowledge41").Type, 1));
				npcLoot.Add(notDownedPolterghast);
