...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStratus
{
	public class StratusChest : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("StratusChest").Type).GetLocalization("DisplayName");
