...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStratus
{
	public class StratusDresser : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("StratusDresser").Type).GetLocalization("DisplayName");
