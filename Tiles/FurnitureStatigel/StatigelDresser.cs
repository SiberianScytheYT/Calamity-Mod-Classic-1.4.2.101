...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStatigel
{
	public class StatigelDresser : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("StatigelDresser").Type).GetLocalization("DisplayName");
