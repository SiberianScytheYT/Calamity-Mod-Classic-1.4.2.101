...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStatigel
{
	public class StatigelChest : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("StatigelChest").Type).GetLocalization("DisplayName");
