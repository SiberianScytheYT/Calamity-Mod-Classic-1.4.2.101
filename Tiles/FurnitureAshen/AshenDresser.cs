...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureAshen
{
	public class AshenDresser : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("AshenDresser").Type).GetLocalization("DisplayName");
