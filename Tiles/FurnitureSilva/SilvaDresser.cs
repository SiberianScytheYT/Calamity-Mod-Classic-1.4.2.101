...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureSilva
{
	public class SilvaDresser : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("SilvaDresser").Type).GetLocalization("DisplayName");
