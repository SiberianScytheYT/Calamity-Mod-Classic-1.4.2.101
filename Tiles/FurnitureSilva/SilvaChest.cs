...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureSilva
{
	public class SilvaChest : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("SilvaChest").Type).GetLocalization("DisplayName");
