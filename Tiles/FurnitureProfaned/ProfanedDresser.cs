...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureProfaned
{
	public class ProfanedDresser : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("ProfanedDresser").Type).GetLocalization("DisplayName");
