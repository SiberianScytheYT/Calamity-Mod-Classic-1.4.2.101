...
namespace CalamityModClassicPreTrailer.Tiles.FurniturePlaguedPlate
{
	public class PlaguedPlateChest : ModTile
	{
		...
		public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(Mod.Find<ModItem>("PlaguedPlateChest").Type).GetLocalization("DisplayName");
